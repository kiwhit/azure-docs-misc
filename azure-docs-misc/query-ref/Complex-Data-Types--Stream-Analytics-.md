...
```  
 ...
 Select all array element as individual events ( the [APPLY &#40;Azure Stream Analytics&#41;](../query-ref/APPLY--Azure-Stream-Analytics-.md) operator together with the [GetArrayElements &#40;Azure Stream Analytics&#41;](../query-ref/GetArrayElements--Azure-Stream-Analytics-.md) built-in function extract all array elements as individual events):  
...
```  
 ...
 Use the [GetRecordPropertyValue &#40;Azure Stream Analytics&#41;](../query-ref/GetRecordPropertyValue--Azure-Stream-Analytics-.md) function if the property name is unknown. For example, imagine a  sample data stream needs to be joined with reference data containing thresholds for each device sensor:  
...
```  
 ...
 To convert record fields into separate events use the [APPLY &#40;Azure Stream Analytics&#41;](../query-ref/APPLY--Azure-Stream-Analytics-.md) operator together with the [GetRecordProperties &#40;Azure Stream Analytics&#41;](../query-ref/GetRecordProperties--Azure-Stream-Analytics-.md) function. For example, to convert a sample stream into a stream of events with individual sensor readings, this query could be used:  
