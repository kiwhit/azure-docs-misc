...
|`Last-Modified`|Returns the date and time the directory was last modified. The date format follows RFC 1123. For more information, see [Representation of Date-Time Values in Headers](../rest-conceptual/Representation-of-Date-Time-Values-in-Headers.md). Any operation that modifies the share or its properties or metadata updates the last modified time. Operations on files do not affect the last modified time of the share.|  
...
## Remarks  
 ...
 To create a new file, call [Create File](../rest-conceptual/Create-File.md). A file may be up to 1 TB in size.  
 ...
 **Sample Unaligned Clear Range**  
 ...
 Suppose a file is created with [Create File](../rest-conceptual/Create-File.md) and a single range is written with `Put Range`, as follows:  
...
```  
 ...
 Performing a [List Ranges](../rest-conceptual/List-Ranges.md) operation on the file will return the following response body:  
...
```  
 ...
 A subsequent [List Ranges](../rest-conceptual/List-Ranges.md) operation on the file will return the following response body:  
