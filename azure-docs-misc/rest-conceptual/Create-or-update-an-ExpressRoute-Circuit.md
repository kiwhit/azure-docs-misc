...
> [!NOTE]
>  Refer to the [Operations on ExpressRoute BGP Peering](../rest-conceptual/Operations-on-ExpressRoute-BGP-Peering.md) section for more details on the BGP Peering parameters.  
