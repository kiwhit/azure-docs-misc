...
The `Get Table Service Properties` operation gets the properties of a storage account’s Table service, including properties for [Storage Analytics](../rest-conceptual/Storage-Analytics.md) and CORS (Cross-Origin Resource Sharing) rules.  
