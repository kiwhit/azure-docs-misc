...
This section provides a quick references for some frequently used commands. For detailed usage, see [Preparing Hard Drives for an Import Job](../rest-conceptual/Preparing-Hard-Drives-for-an-Import-Job.md).  
