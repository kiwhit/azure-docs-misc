...
-   [Prerequisites](../rest-conceptual/Azure-API-Management-REST-API-Subscription-entity.md#Prerequisites)  
  
-   [Get a list of all subscriptions](../rest-conceptual/Azure-API-Management-REST-API-Subscription-entity.md#ListSubscriptions)  
  
-   [Get subscription details](../rest-conceptual/Azure-API-Management-REST-API-Subscription-entity.md#GetSubscription)  
  
-   [Get the metadata for a subscription](../rest-conceptual/Azure-API-Management-REST-API-Subscription-entity.md#GetMetadata)  
  
-   [Subscribe a user to a product](../rest-conceptual/Azure-API-Management-REST-API-Subscription-entity.md#SubscribeProduct)  
  
-   [Update subscription details](../rest-conceptual/Azure-API-Management-REST-API-Subscription-entity.md#UpdateSubscription)  
  
-   [Delete a subscription](../rest-conceptual/Azure-API-Management-REST-API-Subscription-entity.md#DeleteSubscription)  
  
-   [Regenerate subscription primary key](../rest-conceptual/Azure-API-Management-REST-API-Subscription-entity.md#RegeneratePrimaryKey)  
  
-   [Regenerate subscription secondary key](../rest-conceptual/Azure-API-Management-REST-API-Subscription-entity.md#RegenrateSecondaryKey)  
  
> [!NOTE]
>  To return all the subscriptions for a specific product, see [List subscriptions to a product](../rest-conceptual/Azure-API-Management-REST-API-Product-Entity.md#ListSubscriptions) in the [Product](../rest-conceptual/Azure-API-Management-REST-API-Product-Entity.md) reference documentation.  
...
#### 200 OK  
 A [Collection](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#collection) of the [Subscription](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Subscription) entities for the specified API Management service instance.  
...
|ETag|string|Current entity state version. Should be treated as opaque and used to make conditional HTTP requests.|  
 ...
 The response body contains the specified [Subscription](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Subscription) entity.  
...
#### Request body  
 The request body contains a [Subscription](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Subscription) entity. For a complete list of eligible properties for this operation, see the [Subscription](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Subscription) properties in the [Contract reference](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md).  
