...
## Remarks  
 ...
 Once a client has received status code 202 (Accepted), then the directory has been removed from the system and is eligible to be recreated. Subsequent calls to [Get Directory Properties](../rest-conceptual/Get-Directory-Properties.md) will result in 404 (Not Found).  
