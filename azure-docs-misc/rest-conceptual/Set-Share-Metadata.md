...
ms.tgt_pltfrm: na
ms.topic: reference
ms.assetid: 1a593141-5be9-4411-9aff-7c2a0fdd735e
...
|---------------------|-----------------|  
|`Last-Modified`|Returns the date and time the share was last modified. The date format follows RFC 1123. For more information, see [Representation of Date-Time Values in Headers](../rest-conceptual/Representation-of-Date-Time-Values-in-Headers.md). Any operation that modifies the share or its properties updates the last modified time. Operations on files do not affect the last modified time of the share.|  
...
## Remarks  
 ...
 You may also set metadata for a share at the time that it is created, as part of the [Create Share](../rest-conceptual/Create-Share.md) operation.  
