---
title: "List Activity Windows by Activity"
ms.custom: na
ms.date: 2016-07-21
ms.prod: azure
ms.reviewer: na
...
ms.tgt_pltfrm: na
ms.topic: reference
ms.assetid: e7a777ba-00bb-4de0-a3a1-056e47de00a3
...
Gets the first page of activity window instances associated with an activity along with a link to the next page.  
