...
-   [API](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#API)  
  
-   [Authorization Server](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#AuthorizationServer)  
  
-   [Authorization Server authentication settings](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#AuthenticationSettings)  
  
-   [Backend](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Backend)  
  
-   [Certificate](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Certificate)  
  
-   [Group](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Group)  
  
-   [Logger](#Logger)  
  
-   [Operation](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Operation)  
  
-   [Operation-summary](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#OperationSummaryProperties)  
  
-   [Product](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Product)  
  
-   [Property](#Property)  
  
-   [Report](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Report)  
  
-   [Subscription](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Subscription)  
  
-   [User](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#User)  
  
-   [HTTP Request](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#HTTPRequest)  
  
-   [HTTP Response](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#HTTPResponse)  
  
-   [Parameter](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Parameter)  
  
-   [Representation](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Representation)  
  
-   [Error](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#error)  
  
-   [Error body](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#error-body)  
  
-   [Error detail](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#ErrorDetail)  
  
-   [Collection](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#collection)  
  
-   [Policy](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Policy)  
...
> [!NOTE]
>  For more information about `API` entity operations, see [API](../rest-conceptual/Azure-API-Management-REST-API-API-entity.md).  
...
> [!NOTE]
>  For more information about `authorization server` entity operations, see [Authorization Server](../rest-conceptual/Azure-API-Management-REST-API-Authorization-Server-entity.md).  
...
|--------------|----------|-----------------|  
|authorizationServerId|string|OAuth authorization server identifier. Corresponds to the id of one of the [Authorization Server](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#AuthorizationServer) entities in the current service instance.|  
...
> [!NOTE]
>  For more information about `backend` entity operations, see [Backend](../rest-conceptual/Azure-API-Management-REST-API-Backend-entity.md).  
...
|subject|string|Subject attribute of the certificate.|This property is used only the following operations.<br /><br /> - [Get a list of all certificates](../rest-conceptual/Azure-API-Management-REST-API-Certificate-entity.md#List)<br /><br /> - [Get a certificate](../rest-conceptual/Azure-API-Management-REST-API-Certificate-entity.md#Get)|  
...
|data|string|Base 64 encoded certificate using the `application/x-pkcs12` representation.|This property is used only when adding or updating a certificate. For more information, see [Add or update a certificate](../rest-conceptual/Azure-API-Management-REST-API-Certificate-entity.md#Add).|  
|password|string|Password for the certificate.|This property is only used when adding or updating a certificate. For more information, see [Add or update a certificate](../rest-conceptual/Azure-API-Management-REST-API-Certificate-entity.md#Add).|  
  
> [!NOTE]
>  For more information about `certificate` entity operations, see [Certificate](../rest-conceptual/Azure-API-Management-REST-API-Certificate-entity.md).  
...
> [!NOTE]
>  For more information about `group` entity operations, see [Group](../rest-conceptual/Azure-API-Management-REST-API-Group-entity.md).  
...
|templateParameters|array of [Parameter](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Parameter)|Array of URL template parameters.|  
...
|request|[HTTP Request](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#HTTPRequest)|An entity containing request details.|  
|responses|array of [HTTP Response](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#HTTPResponse)|Array of operation [HTTP Response](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#HTTPResponse) entities.|  
  
> [!NOTE]
>  For more information about `operation` entity operations, see the operation methods in the [API](../rest-conceptual/Azure-API-Management-REST-API-API-entity.md) documentation.  
...
> [!NOTE]
>  For more information about `operation-summary` entity operations, see the operation methods in the [API](../rest-conceptual/Azure-API-Management-REST-API-API-entity.md) documentation.  
...
|groups|array|An array of [Group](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Group) entities that have visibility to the product.|This property is optional and is only included in responses when the request has an `expandGroups` query parameter with a value of `true`.|  
  
> [!NOTE]
>  For more information about `product` entity operations, see [Product](../rest-conceptual/Azure-API-Management-REST-API-Product-Entity.md).  
...
> [!NOTE]
>  For more information about `report` entity operations, see [Report](../rest-conceptual/Azure-API-Management-REST-API-Report-entity.md).  
...
> [!NOTE]
>  For more information about `subscription` entity operations, see [Subscription](../rest-conceptual/Azure-API-Management-REST-API-Subscription-entity.md).  
...
|password|string|User password.|For security purposes, this property is not returned in the response body for the following operations.<br /><br /> - [List registered users](../rest-conceptual/Azure-API-Management-REST-API-User-entity.md#List)<br /><br /> - [Get a specific user](../rest-conceptual/Azure-API-Management-REST-API-User-entity.md#GetUser)|  
...
|groups|boolean|An array of [Group](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Group) entities to which the user belongs.|This property is optional and is only included in responses when the request has an `expandGroups` query parameter with a value of `true`.|  
  
> [!NOTE]
>  For more information about `user` entity operations, see [User](../rest-conceptual/Azure-API-Management-REST-API-User-entity.md).  
...
|queryParameters|array of [Parameter](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Parameter)|Collection of operation request query parameters.|  
|headers|array of [Parameter](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Parameter)|Collection of operation request headers.|  
|representations|array of [Representation](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Representation)|Collection of operation request representations.|  
...
|representations|array of [Representation](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Representation)|Collection of operation response representations.|  
...
|Property|Type|Description|  
|--------------|----------|-----------------|  
|error|[Error body](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#error-body)|The error body containing the details of the error.|  
...
|details|[Error detail](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#ErrorDetail)|In case of validation errors this field contains a list of invalid fields sent in the request.|  
