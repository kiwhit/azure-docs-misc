...
---
# Get Share ACL
**Get Share ACL** returns information about stored access policies specified on the share. For more information, see [Establishing a Stored Access Policy](../rest-conceptual/Establishing-a-Stored-Access-Policy.md).  
