...
>   
>  [Policy expressions](../APIManagementPolicyRef/API-Management-policy-expressions.md) cannot be used in any of the policy attributes for this policy.  
