...
##  <a name="Profile"></a> Profile  
 ...
 ![User Profile Page](../APIManagementTemplates/media/APIM-User-Profile-Page.png "APIM User Profile Page")  
...
### Controls  
 This template may not use any [page controls](../APIManagementTemplates/Azure-API-Management-page-controls.md).  
...
|subscriptions|Collection of [Subscription](../APIManagementTemplates/Azure-API-Management-template-data-model-reference.md#Subscription) entities.|The subscriptions for the current user.|  
|applications|Collection of [Application](../APIManagementTemplates/Azure-API-Management-template-data-model-reference.md#Application) entities.|The applications of the current user.|  
...
|isSystemUser|boolean|Whether the current user is a member of one of the built-in [groups](https://azure.microsoft.com/documentation/articles/api-management-key-concepts/#groups).|  
...
##  <a name="Subscriptions"></a> Subscriptions  
 ...
 ![User Subscription Page](../APIManagementTemplates/media/APIM-User-Subscription-Page.png "APIM User Subscription Page")  
...
### Controls  
 This template may use the following [page controls](../APIManagementTemplates/Azure-API-Management-page-controls.md).  
  
-   [subscription-cancel](../APIManagementTemplates/Azure-API-Management-page-controls.md#subscription-cancel)  
...
##  <a name="Applications"></a> Applications  
 ...
 ![User Account Applications Page](../APIManagementTemplates/media/APIM-User-Account-Applications-Page.png "APIM User Account Applications Page")  
...
-   [app-actions](../APIManagementTemplates/Azure-API-Management-page-controls.md#app-actions)  
...
##  <a name="UpdateAccountInfo"></a> Update account info  
 ...
 ![User Account Info Page Developer Portal Templates](../APIManagementTemplates/media/APIM-User-Account-Info-Page-Developer-Portal-Templates.png "APIM User Account Info Page Developer Portal Templates")  
...
### Data model  
 [User account info](../APIManagementTemplates/Azure-API-Management-template-data-model-reference.md#UserAccountInfo) entity.  
