...
### **Input events timestamp**  
 Timestamp of the input event can be defined by column value (or an expression) specified in the [TIMESTAMP BY](../streamAnalyticsQueryLanguage/TIMESTAMP-BY--Azure-Stream-Analytics-.md) clause:  
...
```  
 ...
 The timestamp of the result of the aggregate is the end of the time window to which this result corresponds. Please see [Windowing &#40;Azure Stream Analytics&#41;](../streamAnalyticsQueryLanguage/Windowing--Azure-Stream-Analytics-.md) articles describing different window types in Azure Stream Analytics.  
