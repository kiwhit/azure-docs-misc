...
Azure API Management allows publishers to respond to error conditions that may occur during the processing of requests to the proxy by providing a `ProxyError` object. The `ProxyError` object is accessed through the [context.LastError](../templates/API-Management-policy-expressions.md#ContextVariables) property and can be used by policies in the `on-error` policy section. This topic provides a reference for the error handling capabilities in Azure API Management.  
...
-   [choose](../templates/API-Management-advanced-policies.md#choose)  
  
-   [set-variable](../templates/API-Management-advanced-policies.md#set-variable)  
  
-   [find-and-replace](../templates/API-Management-transformation-policies.md#Findandreplacestringinbody)  
  
-   [return-response](../templates/API-Management-advanced-policies.md#ReturnResponse)  
  
-   [set-header](../templates/API-Management-transformation-policies.md#SetHTTPheader)  
  
-   [set-method](../templates/API-Management-advanced-policies.md#SetRequestMethod)  
  
-   [set-status](../templates/API-Management-advanced-policies.md#SetStatus)  
  
-   [send-request](../templates/API-Management-advanced-policies.md#SendRequest)  
  
-   [send-one-way-request](../templates/API-Management-advanced-policies.md#SendOneWayRequest)  
  
-   [log-to-eventhub](../templates/API-Management-advanced-policies.md#log-to-eventhub)  
  
-   [json-to-xml](../templates/API-Management-transformation-policies.md#ConvertJSONtoXML)  
  
-   [xml-to-json](../templates/API-Management-transformation-policies.md#ConvertXMLtoJSON)  
  
## LastError  
 When an error occurs and control jumps to the `on-error` policy section, the error is stored in  [context.LastError](../templates/API-Management-policy-expressions.md#ContextVariables) property which can be accessed by policies in the `on-error` section and has the following properties.  
