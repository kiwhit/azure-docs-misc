...
##  <a name="Profile"></a> Profile  
 ...
 ![User Profile Page](../templates/media/APIM-User-Profile-Page.png "APIM User Profile Page")  
...
|subscriptions|Collection of [Subscription](../templates/Azure-API-Management-template-data-model-reference.md#Subscription) entities.|The subscriptions for the current user.|  
|applications|Collection of [Application](../templates/Azure-API-Management-template-data-model-reference.md#Application) entities.|The applications of the current user.|  
...
##  <a name="Subscriptions"></a> Subscriptions  
 ...
 ![User Subscription Page](../templates/media/APIM-User-Subscription-Page.png "APIM User Subscription Page")  
...
-   [subscription-cancel](../templates/Azure-API-Management-page-controls.md#subscription-cancel)  
...
##  <a name="Applications"></a> Applications  
 ...
 ![User Account Applications Page](../templates/media/APIM-User-Account-Applications-Page.png "APIM User Account Applications Page")  
...
-   [app-actions](../templates/Azure-API-Management-page-controls.md#app-actions)  
...
##  <a name="UpdateAccountInfo"></a> Update account info  
 ...
 ![User Account Info Page Developer Portal Templates](../templates/media/APIM-User-Account-Info-Page-Developer-Portal-Templates.png "APIM User Account Info Page Developer Portal Templates")  
...
### Data model  
 [User account info](../templates/Azure-API-Management-template-data-model-reference.md#UserAccountInfo) entity.  
