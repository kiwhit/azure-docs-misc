...
##  <a name="ProductList"></a> Product list  
 ...
 ![Products list](../templates/media/APIM_ProductsListTemplatePage.png "APIM_ProductsListTemplatePage")  
...
### Controls  
 The `Product list` template may use the following [page controls](../templates/Azure-API-Management-page-controls.md).  
...
|--------------|----------|-----------------|  
|Paging|[Paging](../templates/Azure-API-Management-template-data-model-reference.md#Paging) entity.|The paging information for the products collection.|  
|Filtering|[Filtering](../templates/Azure-API-Management-template-data-model-reference.md#Filtering) entity.|The filtering information for the products list page.|  
|Products|Collection of [Product](../templates/Azure-API-Management-template-data-model-reference.md#Product) entities.|The products visible to the current user.|  
...
##  <a name="Product"></a> Product  
 ...
 ![Developer portal product page](../templates/media/APIM_ProductPage.png "APIM_ProductPage")  
...
-   [subscribe-button](../templates/Azure-API-Management-page-controls.md#subscribe-button)  
  
### Data model  
  
|Property|Type|Description|  
|--------------|----------|-----------------|  
|Product|[Product](../templates/Azure-API-Management-template-data-model-reference.md#Product)|The specified product.|  
...
|Subscriptions|Collection of [Subscription summary](../templates/Azure-API-Management-template-data-model-reference.md#SubscriptionSummary) entities.|The subscriptions to the product.|  
|Apis|Collection of [API](../templates/Azure-API-Management-template-data-model-reference.md#API) entities.|The APIs in this product.|  
