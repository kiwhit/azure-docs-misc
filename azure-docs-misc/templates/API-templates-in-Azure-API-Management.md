...
##  <a name="APIList"></a> API list  
 ...
 ![Developer Portal API List](../templates/media/APIM-Developer-Portal-Templates-API-List.png "APIM Developer Portal Templates API List")  
...
### Controls  
 The `API list` template may use the following [page controls](../templates/Azure-API-Management-page-controls.md).  
  
-   [paging-control](../templates/Azure-API-Management-page-controls.md#paging-control)  
  
-   [search-control](../templates/Azure-API-Management-page-controls.md#search-control)  
  
### Data model  
  
|Property|Type|Description|  
|--------------|----------|-----------------|  
|apis|Collection of [API summary](../templates/Azure-API-Management-template-data-model-reference.md#APISummary) entities.|The APIs visible to the current user.|  
...
##  <a name="Product"></a> Operation  
 ...
 ![Developer Portal Operation page](../templates/media/APIM-Developer-Portal-templates-Operation-page.png "APIM Developer Portal templates Operation page")  
...
### Controls  
 The `Operation` template does not allow the use of any [page controls](../templates/Azure-API-Management-page-controls.md).  
...
|api|[API summary](../templates/Azure-API-Management-template-data-model-reference.md#APISummary) entity.|The current API.|  
|operation|[Operation](../templates/Azure-API-Management-template-data-model-reference.md#Operation)|The currently displayed operation.|  
|sampleUrl|string|The URL for the current operation.|  
|operationMenu|[Operation menu](../templates/Azure-API-Management-template-data-model-reference.md#Menu)|A menu of operations for this API.|  
|consoleUrl|URI|The URI for the **Try it** button.|  
|samples|Collection of [Code sample](../templates/Azure-API-Management-template-data-model-reference.md#Sample) entities.|The code samples for the current operation..|  
...
##  <a name="CodeSamples"></a> Code samples  
 ...
 ![Developer Portal Templates Code samples](../templates/media/APIM-Developer-Portal-Templates-Code-samples.png "APIM Developer Portal Templates Code samples")  
...
#### Controls  
 The code sample templates do not allow the use of any [page controls](../templates/Azure-API-Management-page-controls.md).  
  
#### Data model  
 [Code sample](../templates/Azure-API-Management-template-data-model-reference.md#Sample) entity.  
