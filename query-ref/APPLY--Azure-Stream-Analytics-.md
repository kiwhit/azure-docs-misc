...
# APPLY (Azure Stream Analytics)
 ...
 There are two table-valued functions available in Azure Stream Analytics to facilitate working with Array and Record type fields. They are [GetArrayElements](../query-ref/GetArrayElements--Azure-Stream-Analytics-.md) and [GetRecordProperties](../query-ref/GetRecordProperties--Azure-Stream-Analytics-.md).  
