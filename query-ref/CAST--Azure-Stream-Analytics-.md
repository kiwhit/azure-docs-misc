...
# CAST (Azure Stream Analytics)
  ...
  For example, CAST ('this is a string' AS bigint) will result in a job failure. When this is not a desired outcome use [TRY_CAST &#40;Azure Stream Analytics&#41;](../query-ref/TRY_CAST--Azure-Stream-Analytics-.md) instead.
