...
## Remarks  
 This operation returns only user-defined metadata on the container. To return system properties as well, call [Get Container Properties](../rest-conceptual/Get-Container-Properties.md).  
