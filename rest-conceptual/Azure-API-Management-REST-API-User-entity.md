...
-   [Create a new user](../rest-conceptual/Azure-API-Management-REST-API-User-entity.md#CreateUser)  
  
-   [Update a user](../rest-conceptual/Azure-API-Management-REST-API-User-entity.md#UpdateUser)  
  
-   [Delete a user](../rest-conceptual/Azure-API-Management-REST-API-User-entity.md#DeleteUser)  
  
-   [List developer groups associated with a user](../rest-conceptual/Azure-API-Management-REST-API-User-entity.md#ListGroups)  
  
-   [List subscriptions for a specific user](../rest-conceptual/Azure-API-Management-REST-API-User-entity.md#ListSubscriptions)  
  
-   [Get single sign-on URL for a user](../rest-conceptual/Azure-API-Management-REST-API-User-entity.md#SSO)  
...
#### 200 OK  
 This operation returns a [Collection](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#collection) of [User](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#User) entities.  
