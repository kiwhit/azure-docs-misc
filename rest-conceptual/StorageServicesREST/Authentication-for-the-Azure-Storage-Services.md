...
```  
 ...
 The following example shows a signature string for a [Get Blob](../StorageServicesREST/Get-Blob.md) operation. Note that where there is no header value, the new-line character only is specified.  
...
> [!NOTE]
>  Beginning with version 2009-09-19, the Table service requires that all REST calls include the `DataServiceVersion` and `MaxDataServiceVersion` headers. See [Setting the OData Data Service Version Headers](../StorageServicesREST/Setting-the-OData-Data-Service-Version-Headers.md) for more information.  
...
```  
 ...
 The following example shows a signature string for a [Put Blob](../StorageServicesREST/Put-Blob.md) operation. Note that the Content-MD5 header line is empty. The headers shown in the string are name-value pairs that specify custom metadata values for the new blob.  
...
```  
 ...
 The following example shows a signature string for a [Create Table](../StorageServicesREST/Create-Table.md) operation.  
...
-   Blob service: [Naming and Referencing Containers, Blobs, and Metadata](../StorageServicesREST/Naming-and-Referencing-Containers--Blobs--and-Metadata.md)  
  
-   Queue service: [Addressing Queue Service Resources](../StorageServicesREST/Addressing-Queue-Service-Resources.md)  
  
-   Table service: [Addressing Table Service Resources](../StorageServicesREST/Addressing-Table-Service-Resources.md)  
  
-   File service: [Naming and Referencing Shares, Directories, Files, and Metadata](../StorageServicesREST/Naming-and-Referencing-Shares--Directories--Files--and-Metadata.md)  
