...
ms.tgt_pltfrm: na
ms.topic: reference
ms.assetid: fa6926d6-3c89-4c9d-8566-ab207b0b471b
...
## Remarks  
 ...
 To construct a request for a read operation against the secondary endpoint, append `-secondary` as a suffix to the account name in the URI that you use to read from Queue storage. For example, a secondary URI for the [Peek Messages](../StorageServicesREST/Peek-Messages.md) operation will be similar to `https://myaccount-secondary.queue.core.windows.net/myqueue/messages?peekonly=true`.  
