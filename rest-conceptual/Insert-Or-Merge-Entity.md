...
### Request Body  
 The `Insert Or Merge Entity` operation sends the entity to be inserted as an OData entity set, which may be either an Atom or JSON payload. For more information, see [Inserting and Updating Entities](../rest-conceptual/Inserting-and-Updating-Entities.md).  
...
## Remarks  
 ...
 To explicitly type a property, specify the appropriate OData type by setting the `m:type` attribute within the property definition in the Atom feed. For more information about typing properties, see [Inserting and Updating Entities](../rest-conceptual/Inserting-and-Updating-Entities.md).  
