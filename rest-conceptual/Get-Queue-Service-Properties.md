...
The `Get Queue Service Properties` operation gets the properties of a storage account’s Queue service, including properties for [Storage Analytics](../rest-conceptual/Storage-Analytics.md) and CORS (Cross-Origin Resource Sharing) rules.  
