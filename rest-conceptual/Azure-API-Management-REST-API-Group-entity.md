...
-   [Prerequisites](../rest-conceptual/Azure-API-Management-REST-API-Group-entity.md#Prerequisites)  
  
-   [Get a list of all groups](../rest-conceptual/Azure-API-Management-REST-API-Group-entity.md#ListGroups)  
  
-   [Get a specific group](../rest-conceptual/Azure-API-Management-REST-API-Group-entity.md#GetGroup)  
  
-   [Get the metadata for a specific group](../rest-conceptual/Azure-API-Management-REST-API-Group-entity.md#GetGroupMetadata)  
  
-   [Create a new group](../rest-conceptual/Azure-API-Management-REST-API-Group-entity.md#CreateGroup)  
  
-   [Update an existing group](../rest-conceptual/Azure-API-Management-REST-API-Group-entity.md#UpdateGroup)  
  
-   [Delete a group](../rest-conceptual/Azure-API-Management-REST-API-Group-entity.md#DeleteGroup)  
  
-   [List group members](../rest-conceptual/Azure-API-Management-REST-API-Group-entity.md#ListGroupMembers)  
  
-   [Add a member to a group](../rest-conceptual/Azure-API-Management-REST-API-Group-entity.md#AddMember)  
  
-   [Remove a member from a group](../rest-conceptual/Azure-API-Management-REST-API-Group-entity.md#RemoveMember)  
  
-   [Check membership in a group](../rest-conceptual/Azure-API-Management-REST-API-Group-entity.md#CheckMembership)  
...
#### 200 OK  
 A [Collection](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#collection) of the [Group](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Group) entities for the specified API Management service instance.  
...
|ETag|string|Current entity state version. Should be treated as opaque and used to make conditional HTTP requests.|  
 ...
 The response body contains the specified [Group](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Group) entity.  
...
#### Request body  
 ...
 The request body contains a [Group](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Group) entity. For a complete list of eligible properties for this operation, see the [Group](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Group) properties in the [Contract reference](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md).  
...
#### 200 OK  
 This operation returns a [Collection](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#collection) of [user](ABC) entities.  
