...
-   [Create or import a new API](../rest-conceptual/Azure-API-Management-REST-API-API-entity.md#CreateAPI)  
...
#### 200 OK  
 A [Collection](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#collection) of the [API](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#API) entities for the specified API Management service instance.  
...
#### 200 OK  
 A [Collection](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#collection) of the [Operation-summary](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#OperationSummaryProperties) entities for the specified API.  
...
|ETag|string|Current entity state version. Should be treated as opaque and used to make conditional HTTP requests.|  
 ...
 The response body contains the specified [Operation](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Operation) entity.  
