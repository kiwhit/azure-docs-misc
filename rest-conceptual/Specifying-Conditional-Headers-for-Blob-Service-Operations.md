...
## Specifying Conditional Headers for Blob Service Read Operations in Version 2013-08-15 or Later  
 Beginning with version 2013-08-15, the [Get Blob](../rest-conceptual/Get-Blob.md) and [Get Blob Properties](../rest-conceptual/Get-Blob-Properties.md) operations support multiple conditional headers. You can specify any combination of supported conditional headers. The Blob service will evaluate these conditions according to following expression:  
 ...
 **Example 1:**  
 ...
 Consider a [Get Blob](../rest-conceptual/Get-Blob.md) request containing the `If-Match` and `If-Modified-Since` headers. The following table indicates the result if the headers are evaluated individually, and the result if they are evaluated in combination.  
...
## Specifying Conditional Headers for Read Operations in Versions Prior to 2013-08-15, and for Write Operations (All Versions)  
 When calling Blob service read operations ([Get Blob](../rest-conceptual/Get-Blob.md) and [Get Blob Properties](../rest-conceptual/Get-Blob-Properties.md)) with versions prior to 2013-08-15, and when calling any write operation regardless of version, keep in mind the following:  
...
|[Copy Blob](../rest-conceptual/Copy-Blob.md)|Read and Write|For conditions on the destination blob:<br /><br /> -                     **If-Modified-Since**<br /><br /> -                     **If-Unmodified-Since**<br /><br /> -                     **If-Match**<br /><br /> -                     **If-None-Match**<br /><br /> For conditions on the source blob:<br /><br /> -                     **x-ms-source-if-modified-since**<br /><br /> -                     **x-ms-source-if-unmodified-since**<br /><br /> -                     **x-ms-source-if-match**<br /><br /> -                     **x-ms-source-if-none-match**|  
|[Delete Blob](../rest-conceptual/Delete-Blob.md)|Write|**If-Modified-Since**<br /><br /> **If-Unmodified-Since**<br /><br /> **If-Match**<br /><br /> **If-None-Match**|  
|[Delete Container](../rest-conceptual/Delete-Container.md)|Write|**If-Modified-Since**<br /><br /> **If-Unmodified-Since**|  
|[Get Blob](../rest-conceptual/Get-Blob.md)|Read|**If-Modified-Since**<br /><br /> **If-Unmodified-Since**<br /><br /> **If-Match**<br /><br /> **If-None-Match**|  
|[Get Blob Metadata](../rest-conceptual/Get-Blob-Metadata.md)|Read|**If-Modified-Since**<br /><br /> **If-Unmodified-Since**<br /><br /> **If-Match**<br /><br /> **If-None-Match**|  
|[Get Blob Properties](../rest-conceptual/Get-Blob-Properties.md)|Read|**If-Modified-Since**<br /><br /> **If-Unmodified-Since**<br /><br /> **If-Match**<br /><br /> **If-None-Match**|  
|[Get Page Ranges](../rest-conceptual/Get-Page-Ranges.md)|Write|**If-Modified-Since**<br /><br /> **If-Unmodified-Since**<br /><br /> **If-Match**<br /><br /> **If-None-Match**|  
|[Lease Blob](../rest-conceptual/Lease-Blob.md)|Write|**If-Modified-Since**<br /><br /> **If-Unmodified-Since**<br /><br /> **If-Match**<br /><br /> **If-None-Match**|  
|[Lease Container](../rest-conceptual/Lease-Container.md)|Write|**If-Modified-Since**<br /><br /> **If-Unmodified-Since**|  
|[Put Blob](../rest-conceptual/Put-Blob.md)|Write|**If-Modified-Since**<br /><br /> **If-Unmodified-Since**<br /><br /> **If-Match**<br /><br /> **If-None-Match**|  
|[Put Block List](../rest-conceptual/Put-Block-List.md)|Write|**If-Modified-Since**<br /><br /> **If-Unmodified-Since**<br /><br /> **If-Match**<br /><br /> **If-None-Match**|  
|[Append Block](../rest-conceptual/Append-Block.md)<br /><br /> (version 2015-02-21 and later)|Write|**If-Modified-Since**<br /><br /> **If-Unmodified-Since**<br /><br /> **If-Match**<br /><br /> **If-None-Match**|  
|[Put Page](../rest-conceptual/Put-Page.md)|Write|**If-Modified-Since**<br /><br /> **If-Unmodified-Since**<br /><br /> **If-Match**<br /><br /> **If-None-Match**|  
|[Set Blob Metadata](../rest-conceptual/Set-Blob-Metadata.md)|Write|**If-Modified-Since**<br /><br /> **If-Unmodified-Since**<br /><br /> **If-Match**<br /><br /> **If-None-Match**|  
|[Set Blob Properties](../rest-conceptual/Set-Blob-Properties.md)|Write|**If-Modified-Since**<br /><br /> **If-Unmodified-Since**<br /><br /> **If-Match**<br /><br /> **If-None-Match**|  
|[Set Container ACL](../rest-conceptual/Set-Container-ACL.md)|Write|**If-Modified-Since**<br /><br /> **If-Unmodified-Since**|  
|[Set Container Metadata](../rest-conceptual/Set-Container-Metadata.md)|Write|**If-Modified-Since**|  
|[Snapshot Blob](../rest-conceptual/Snapshot-Blob.md)|Read|**If-Modified-Since**<br /><br /> **If-Unmodified-Since**<br /><br /> **If-Match**<br /><br /> **If-None-Match**|  
...
## Copy Operations  
 The following table indicates the response codes returned for an unmet condition for each conditional header when the operation is a copy operation. The [Copy Blob](../rest-conceptual/Copy-Blob.md) operation uses the verbs PUT.  
