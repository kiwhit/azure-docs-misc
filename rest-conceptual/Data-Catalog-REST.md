...
To learn more, see [Data Catalog REST API reference](../rest-conceptual/Data-Catalog-REST-API-reference.md).  
...
To learn more, see [Data Catalog Search syntax reference](../rest-conceptual/Data-Catalog-Search-syntax-reference.md).  
