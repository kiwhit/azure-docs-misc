...
-   [List loggers](../rest-conceptual/Azure-API-Management-REST-API-Logger-entity.md#List)  
  
-   [Get a specific logger](../rest-conceptual/Azure-API-Management-REST-API-Logger-entity.md#GET)  
  
-   [Get the metadata for a specific logger](../rest-conceptual/Azure-API-Management-REST-API-Logger-entity.md#HEAD)  
  
-   [Create a logger](../rest-conceptual/Azure-API-Management-REST-API-Logger-entity.md#PUT)  
  
-   [Update a logger](../rest-conceptual/Azure-API-Management-REST-API-Logger-entity.md#PATCH)  
  
-   [Delete a logger](../rest-conceptual/Azure-API-Management-REST-API-Logger-entity.md#DELETE)  
...
#### 200 OK  
 This operation returns a [collection](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#collection) of [Logger](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Logger) entities.  
...
|ETag|string|Current entity state version. Should be treated as opaque and used to make conditional HTTP requests.|  
 ...
 The response body contains the specified [Logger](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Logger) entity.  
...
#### Request body  
 The request body contains a [Logger](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Logger) entity. For a complete list of eligible properties for this operation, see the [Logger](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md#Logger) properties in the [Contract reference](../rest-conceptual/Azure-API-Management-REST-API-contract-reference.md).  
