...
## Remarks  
 This operation returns only user-defined metadata on the share. To return system properties as well, call [Get Share Properties](../rest-conceptual/Get-Share-Properties.md).  
