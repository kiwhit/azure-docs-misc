...
##  <a name="ProductList"></a> Application list  
 ...
 ![Application List Page Developer Portal Templates](../templates/media/APIM-Application-List-Page-Developer-Portal-Templates.png "APIM Application List Page Developer Portal Templates")  
...
|Applications|Collection of [Application](../templates/Azure-API-Management-template-data-model-reference.md#Application) entities.|The applications visible to the current user.|  
...
##  <a name="Application"></a> Application  
 ...
 ![Application Page Developer Portal Templates](../templates/media/APIM-Application-Page-Developer-Portal-Templates.png "APIM Application Page Developer Portal Templates")  
...
### Controls  
 The `Application` template does not allow the use of any [page controls](../templates/Azure-API-Management-page-controls.md).  
  
### Data model  
 [Application](../templates/Azure-API-Management-template-data-model-reference.md#Application) entity.  
